...
#define DESC_BASE_DIR 0
#define DESC_PRIV_LVL_0 0
#define DESC_PRIV_LVL_3 3
#define DESC_PRESENT 1
#define DESC_AVL_CLEAR 0
#define DESC_L_CLEAR 0
#define DESC_DB_SET 1
#define DESC_GRANULARITY_SET 1
#define DESC_GRANULARITY_CLEAR 0
...
#define GET_PHY_PADDR(X) (X << 12)
#define SET_PHY_PADDR(X) (X >> 12)
