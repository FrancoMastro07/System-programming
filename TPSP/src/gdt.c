    ...
    [GDT_IDX_CODE_0] =
        {
            ...
            .base_15_0 = GDT_BASE_LOW(DESC_BASE_DIR),
            .base_23_16 = GDT_BASE_MID(DESC_BASE_DIR),
            ...
            .l = DESC_L_CLEAR,
            .db = DESC_DB_SET,
            .g = DESC_GRANULARITY_SET,
            .base_31_24 = GDT_BASE_HIGH(DESC_BASE_DIR),
        },
    [GDT_IDX_CODE_3] =
        {
            .limit_15_0 = GDT_LIMIT_LOW(GDT_LIMIT_4KIB(FLAT_SEGM_SIZE)),
